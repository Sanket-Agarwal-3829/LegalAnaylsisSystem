class MultiInput extends HTMLElement {
  constructor() {
    ...
    multi-input .records .item::after {
      color: black;
      content: '×';
      cursor: pointer;
      font-size: 18px;
    ...
    ::slotted(.records div.item:hover) {
  ...
  _addItem(value) {
    ...
    this._input.previousElementSibling.appendChild(item)
    // this.insertBefore(item, this._input.previousSibling);
